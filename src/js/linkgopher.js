document.addEventListener('DOMContentLoaded', function () {
    ...
    const filtering = location.search.replace(
    ...
    function handler(links, pattern, onlyDomains) {
        ...
        const domains = [
            ...new Set(added.map((link) => getBaseURL(link))),
        ].sort()
    ...
    document
        ...
        .addEventListener('click', applyThemeStyles)
